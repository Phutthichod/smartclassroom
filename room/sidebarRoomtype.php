...
<li class="nav-item active">
    ...
    <div id="room" class="collapse show" aria-labelledby="headingUtilities"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">การจัดการห้อง:</h6>
            <a class="collapse-item " href="room.php">ห้อง</a>
            <a class="collapse-item active" href='roomtype.php'>ชนิดห้อง</a>
        </div>
    </div>
</li>
<li class="nav-item">
