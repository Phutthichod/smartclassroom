                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header card-header-table py-3">
                            <h6 class="m-0 font-weight-bold">แก้ไขอุปกรณ์ >>> รูปอุปกรณ์</h6></h6>
                        </div>
                        <div class="card-body">
                            <div class="container">
                                <div class="upload-grid">
                                    <div class="card shadow cardgall">
                                        <div class="card-body ">
                                            <img src="20368859_1395454127203972_8252860284181145383_o.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="card shadow cardgall">
                                        <div class="card-body ">
                                ...
                                <div class="grid-button-page2">
                                    <a class="btn-submit" href="tool.php"><button type="submit" class="btn btn-primary  ">บันทึก</button></a>
