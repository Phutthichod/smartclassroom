...
<li class="nav-item active">
    ...
    <div id="subject" class="collapse show" aria-labelledby="headingUtilities"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">การจัดการวิชา:</h6>
            <a class="collapse-item "  href='course.php'>หลักสูตร</a>
            <a class="collapse-item active" href='subject.php'>รายวิชา</a>
        </div>
    </div>
</li>
<!-- Divider -->
